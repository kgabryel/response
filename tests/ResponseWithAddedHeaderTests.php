...
class ResponseWithAddedHeaderTests extends TestCase
{
    ...
    {
        $response = new Response();
        $response->withAddedHeader('Content-Type', ['text/plain', 'charset/UTF-8']);
        $expectedValue = new Map();
        $expectedValue['Content-Type'] = new Vector();
        $expectedValue['Content-Type']->push('text/plain');
    ...
    public function test3()
    {
        $response = new Response();
        $response->withAddedHeader('Content-Type', 'text/plain');
        $response->withAddedHeader('WWW-Authenticate', 'Negotiate');
        $expectedValue = new Map();
        $expectedValue['Content-Type'] = new Vector();
        $expectedValue['Content-Type']->push('text/plain');
    ...
    public function test5()
    {
        ...
        $response->withAddedHeader('Content-Type', 'text/plain');
        $response->withAddedHeader('WWW-Authenticate', 'Negotiate');
        $response->withAddedHeader('content-type', 'application/json', true);
        $expectedValue = new Map();
        $expectedValue['WWW-Authenticate'] = new Vector();
        $expectedValue['WWW-Authenticate']->push('Negotiate');
        $expectedValue['content-type'] = new Vector();
